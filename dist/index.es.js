...
var useSelection = function useSelection(editorRef) {
  ...
  var restoreSelection = useCallback(
    function () {
      try {
...
var useFormatting = function useFormatting(
  ...
  var toggleUnderline = useCallback(
    function () {
  ...
  var insertBulletList = useCallback(
    function () {
  ...
  var insertNumberedList = useCallback(
    function () {
...
var useVariables = function useVariables(
  ...
  var getAllVariables = useCallback(
    function () {
  ...
  var generatePopulatedContent = useCallback(
  ...
  var populateVariables = useCallback(
  ...
  var insertVariable = useCallback(
...
var useKeyboardShortcuts = function useKeyboardShortcuts(editorRef, handlers) {
  ...
  var handleToolbarKeyDown = useCallback(
    function (e) {
      try {
...
var useEditorContent = function useEditorContent(initialValue, onChange) {
  ...
  var setEditorContent = useCallback(
    function (newContent) {
      try {
...
var GravyJS = /*#__PURE__*/ forwardRef(function (_ref, ref) {
  ...
  var handleInsertVariable = useCallback(
    function () {
      insertVariable(
        currentRange,
        saveSelection,
  ...
  var handleToggleSnippets = useCallback(
    function () {
  ...
  var handleEditorInput = useCallback(
    function () {
      updateContent();
    },
    [updateContent],
