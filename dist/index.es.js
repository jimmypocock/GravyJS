...
var Toolbar = function Toolbar(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    "aria-label": "Insert variable placeholder using ".concat(variablePrefix).concat(variableSuffix, " format"),
    type: "button"
  }, variablePrefix, variableSuffix), /*#__PURE__*/React.createElement("button", {
...
var SnippetDropdown = function SnippetDropdown(_ref) {
  ...
  var filteredSnippets = snippets.filter(function (snippet) {
    try {
      return snippet.title.toLowerCase().includes(snippetSearch.toLowerCase()) || snippet.content.toLowerCase().includes(snippetSearch.toLowerCase());
    } catch (error) {
  ...
  useEffect(function () {
    var handleClickOutside = function handleClickOutside(event) {
      try {
        var snippetDropdown = event.target.closest('.gravy-snippets-dropdown');
        var snippetButton = event.target.closest('.toolbar-btn[title="Insert Snippet"]');
  ...
  }, filteredSnippets.length > 0 ? filteredSnippets.map(function (snippet, index) {
    return /*#__PURE__*/React.createElement("div", {
      key: index,
...
var useSelection = function useSelection(editorRef) {
  ...
  var restoreSelection = useCallback(function () {
    try {
...
var useFormatting = function useFormatting(editorRef, updateContent, saveSelection, restoreSelection) {
  ...
  var createLink = useCallback(function () {
    try {
      saveSelection();
      var selection = window.getSelection();
...
var useVariables = function useVariables(editorRef, variablePrefix, variableSuffix, onVariablePrompt) {
  // Escape HTML content to prevent XSS attacks
  var escapeHtml = useCallback(function (text) {
    try {
  ...
  var extractPlainText = useCallback(function (html) {
    try {
  ...
  var getAllVariables = useCallback(function () {
    ...
    try {
      ...
      var escapedPrefix = variablePrefix.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
      var escapedSuffix = variableSuffix.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
      var regex = new RegExp("".concat(escapedPrefix, "([a-zA-Z_][a-zA-Z0-9_]*)").concat(escapedSuffix), 'g');
  ...
  var generatePopulatedContent = useCallback(function (variableValues) {
    if (!editorRef.current) return '';
    try {
      var content = editorRef.current.innerHTML;

      // Replace each variable with its value
      for (var _i = 0, _Object$entries = Object.entries(variableValues); _i < _Object$entries.length; _i++) {
        var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2),
          variable = _Object$entries$_i[0],
          value = _Object$entries$_i[1];
        var escapedPrefix = variablePrefix.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
        var escapedSuffix = variableSuffix.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
        var regex = new RegExp("".concat(escapedPrefix).concat(variable).concat(escapedSuffix), 'g');
  ...
  var populateVariables = useCallback(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var variables, variableValues, allValuesProvided, _iterator, _step, variable, value, proceed, populatedContent;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          alert("No variables found in the template. Insert variables using the format ".concat(variablePrefix, "variable_name").concat(variableSuffix));
        ...
        case 10:
          ...
          _context.prev = 14;
          _context.next = 17;
          return onVariablePrompt(variable, variablePrefix, variableSuffix);
        case 17:
          value = _context.sent;
          _context.next = 24;
          break;
        case 20:
          ...
          console.error('Error with custom variable prompt:', _context.t0);
          return _context.abrupt("return", null);
        case 24:
          _context.next = 27;
          break;
        case 26:
          ...
          value = prompt("Enter value for ".concat(variablePrefix).concat(variable).concat(variableSuffix, ":"));
        case 27:
        ...
        case 41:
          ...
          proceed = confirm('Some variables were left empty. Continue anyway?');
          if (proceed) {
            _context.next = 45;
            break;
          }
    ...
    }, _callee, null, [[0, 49], [8, 35, 38, 41], [14, 20]]);
  ...
  var insertVariable = useCallback(function (currentRange, saveSelection, restoreSelection, updateContent) {
    try {
      saveSelection();
      ...
      if (range) {
        ...
        var variableText = "".concat(variablePrefix).concat(trimmedName).concat(variableSuffix);
...
var useKeyboardShortcuts = function useKeyboardShortcuts(editorRef, handlers) {
  ...
  var handleToolbarKeyDown = useCallback(function (e) {
    try {
      if (e.key === 'ArrowRight' || e.key === 'ArrowLeft') {
        var buttons = Array.from(document.querySelectorAll('.gravy-toolbar .toolbar-btn'));
...
var useEditorContent = function useEditorContent(initialValue, onChange) {
  ...
  var updateContent = useCallback(function () {
  ...
  var setEditorContent = useCallback(function (newContent) {
    try {
...
var GravyJS = /*#__PURE__*/forwardRef(function (_ref, ref) {
  var _ref$initialValue = _ref.initialValue,
    ...
    variablePrefix = _ref$variablePrefix === void 0 ? '[[' : _ref$variablePrefix,
    _ref$variableSuffix = _ref.variableSuffix,
    variableSuffix = _ref$variableSuffix === void 0 ? ']]' : _ref$variableSuffix,
  ...
  var _useVariables = useVariables(editorRef, variablePrefix, variableSuffix, onVariablePrompt),
  ...
  var _useFormatting = useFormatting(editorRef, updateContent, saveSelection, restoreSelection),
  ...
  var handleToolbarFocus = useCallback(function () {
    var firstToolbarButton = document.querySelector('.gravy-toolbar .toolbar-btn');
  ...
  var insertSnippet = useCallback(function (snippet) {
    try {
      saveSelection();
      var selection = window.getSelection();
      if (currentRange) {
