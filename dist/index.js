...
var useSelection = function useSelection(editorRef) {
  ...
  var restoreSelection = React.useCallback(function () {
    try {
...
var useFormatting = function useFormatting(editorRef, updateContent, saveSelection, restoreSelection) {
  ...
  var applyFormat = React.useCallback(function (tag) {
  ...
  var insertBulletList = React.useCallback(function () {
    return insertList(false);
  }, [insertList]);

  // Insert an ordered (numbered) list
  var insertNumberedList = React.useCallback(function () {
  ...
  var createLink = React.useCallback(function () {
    try {
      saveSelection();
      var selection = window.getSelection();
...
var useVariables = function useVariables(editorRef, variablePrefix, variableSuffix, onVariablePrompt) {
  ...
  var getAllVariables = React.useCallback(function () {
  ...
  var generatePopulatedContent = React.useCallback(function (variableValues) {
    if (!editorRef.current) return '';
    try {
  ...
  var populateVariables = React.useCallback(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  ...
  var insertVariable = React.useCallback(function (currentRange, saveSelection, restoreSelection, updateContent) {
    try {
      saveSelection();
...
var useKeyboardShortcuts = function useKeyboardShortcuts(editorRef, handlers) {
  ...
  var handleToolbarKeyDown = React.useCallback(function (e) {
    try {
...
var useEditorContent = function useEditorContent(initialValue, onChange) {
  ...
  var updateContent = React.useCallback(function () {
  ...
  var setEditorContent = React.useCallback(function (newContent) {
    try {
...
var GravyJS = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var insertSnippet = React.useCallback(function (snippet) {
    try {
      saveSelection();
      var selection = window.getSelection();
      if (currentRange) {
  ...
  var handleEditorInput = React.useCallback(function () {
    updateContent();
  }, [updateContent]);
