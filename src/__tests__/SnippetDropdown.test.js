...
describe('SnippetDropdown', () => {
  ...
  test('snippet preview truncates content correctly', () => {
    const longSnippet = {
      title: 'Long Content',
      content: '<p>This is a very long snippet content that should be truncated after 50 characters</p>'
    };
    
    render(<SnippetDropdown {...defaultProps} snippets={[longSnippet]} />);
    
    const preview = screen.getByText(/This is a very long snippet content that should be/);
